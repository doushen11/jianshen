...
<article class="page-container">
	<div class="form form-horizontal" id="form-article-add" action="#">
        ...
        <div class="row cl" id="fengmian" style="display:none;">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>封面图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
                <a href="javascript:show_imgs();" id="tupian_inner">暂无</a>
                <input type="hidden" id="tupian" name="tupian" value="">
                <span id="tong" style="display:none;"><p align="center"></p></span>
			</div>
		</div>
        ...
        <div class="row cl" id="z_1">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
                ...
                <input type="button" value="选择图片文件"  class="btn btn-default btn-uploadstar radius" onClick="z_imgs('1');">&nbsp;&nbsp;&nbsp;
                <input name="tw1" type="text" class="wenzi" id="tw1" placeholder="请填写匹配文字,最多500字" value="" maxlength="500"> 
                &nbsp;&nbsp;&nbsp; <span id="b1" style="display:none;"><a href="javascript:show_img('1');" style="color:#FF0000;">已经上传图片,点击查看&nbsp;&nbsp;&nbsp;</a></span><span id="c1" style="display:none;"></span> <a href="javascript:add_one();">添加一条</a>
        ...
        <form id="shenxu2" name="shenxu2" action="<?php echo http_url();?>admin/machines/mv_uploads" method="post" enctype="multipart/form-data" class="definewidth m20" target="rs2">
      	<div class="row cl" id="z_2" style="display:none;">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 添加一条器材信息 </button> &nbsp;&nbsp;&nbsp;&nbsp; <font color="#FF0000">视频大小请控制在8M以内</font>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/machines/adds_subs/<?php echo intval(@$_GET["id"]);?>", 
				type: 'POST', 
