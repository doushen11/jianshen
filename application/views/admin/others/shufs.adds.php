...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 添加轮播图 <a id="shuaxins" class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i id="wysx" class="Hui-iconfont">&#xe68f;</i></a></nav>
<article class="page-container">
	<div class="form form-horizontal" id="form-article-add" action="#">
    	
       
        <div class="row cl" id="show_a" style="display:none;">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="alt" name="alt">
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 添加轮播图信息</button>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/others/shufs_inserts", 
				type: 'POST', 
				data:{file:tupian,alt:alt,content:content,act:"<?php echo $id;?>"}, 
				dataType: 'html', 
				timeout: 15000, 
					error: function(){
						layer.closeAll();
					...
					success:function(result){
						...
						if(result.indexOf("|")>0){
							...
							if(arr[0]==10000){
								...
								setTimeout("location='<?php echo http_url();?>admin/others/shufs?act=<?php echo $id;?>'",1500);
							}else if(arr[0]==20000){
