...
<title>智能健身后台管理系统</title>
<link rel="stylesheet" href="<?php echo base_url();?>public/admin/css/bootstrap.css" />
 
<script type="text/javascript" src="<?php echo base_url();?>public/admin/js/jquery1.9.0.min.js"></script>
...
<style type="text/css">
body{ background:#0066A8 url(<?php echo base_url();?>public/admin/img/login_bg.png) no-repeat center 0px;}
.tit{ margin:auto; margin-top:170px; text-align:center; width:350px; padding-bottom:20px;}
.login-wrap{ width:220px; padding:30px 50px 0 330px; height:220px; background:#fff url(<?php echo base_url();?>public/admin/img/20150212154319.jpg) no-repeat 30px 40px; margin:auto; overflow: hidden;}
.login_input{ display:block;width:210px;}
.login_user{ background: url(<?php echo base_url();?>public/admin/img/input_icon_1.png) no-repeat 200px center; font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif}
.login_password{ background: url(<?php echo base_url();?>public/admin/img/input_icon_2.png) no-repeat 200px center; font-family:"Courier New", Courier, monospace}
			...
			else
			{
				...
				timeout: 15000, 
					...
					success:function(result){
						...
						if(result=="success"){
							location="<?php echo http_url();?>admin/home/indexs";
						}else{
...
<body>
<div class="tit"><img src="<?php echo base_url();?>public/admin/img/tit.png" alt="" /></div>
<div class="login-wrap">
<form action="<?php echo http_url();?>admin/login/subs" onsubmit="return login_sub();" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">	
