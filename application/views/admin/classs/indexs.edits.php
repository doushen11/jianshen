	...
	<div class="form form-horizontal" id="form-article-add" action="#">
        ...
        <div class="row cl" id="sx_1">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <a href="javascript:show_imgs();" id="tupian_inner"><img src="/<?php echo $result["bg_file"];?>" style="max-height:180px; max-width:180px;"></a>
                <input type="hidden" id="tupian" name="tupian" value="<?php echo $result["bg_file"];?>">
                <span id="tong" style="display:none;"><p align="center"><img src="/<?php echo $result["bg_file"];?>" style="max-height:340px; max-width:520px;"></p></span>
			</div>
		</div>
        ...
        <div class="row cl" style="display:none;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $result["counts"];?>" placeholder="" id="counts" name="counts">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select id="act" name="act" onChange="show_models();">
                	<option value="1"<?php if($result["act"]==1){?> selected<?php }?>>图片</option>
                    <option value="2"<?php if($result["act"]==2){?> selected<?php }?>>视频</option>
                </select>
			</div>
		</div>
        
        <span id="beyond_1" <?php if($result["act"]==2){?>style="display:none;"<?php }?>>
 		<div class="row cl" id="sx_2" <?php if($result["act"]==2){?>style="display:none;"<?php }?>>
            ...
            <label class="form-label col-xs-4 col-sm-2">课类展示图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
                <a href="javascript:show_imgs1();" id="tupian_inner1"><img src="/<?php echo $result["path"];?>" style="max-height:180px; max-width:180px;"></a>
                <input type="hidden" id="tupian1" name="tupian1" value="<?php echo $result["path"];?>">
                <span id="tong1" style="display:none;"><p align="center"><img src="/<?php echo $result["path"];?>" style="max-height:340px; max-width:520px;"></p></span>
			</div>
            <?php }?>
		</div>
        ...
        <span id="beyond_2" <?php if($result["act"]==1){?>style="display:none;"<?php }?>>
        ...
        <form id="shenxu2" name="shenxu2" action="<?php echo http_url();?>admin/machines/mv_uploads" method="post" enctype="multipart/form-data" class="definewidth m20" target="rs2">
      	<div class="row cl" id="z_2">
            ...
            <input type="button" value="选择视频文件"  class="btn btn-default btn-uploadstar radius" onClick="c_video();">  <span id="mv_puts" style="display:none"><input type="file" id="mv_file" name="mv_file" value="" onChange="upload_mv();"></span>&nbsp;&nbsp;&nbsp; <span id="shiping" style="display:none;"><strong style="color:#FF0000">已经上传成功</strong></strong></span><input type="hidden" id="mv" name="mv" value="<?php if($result["act"]==2){echo $result["path"];}?>">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
              <textarea name="contents" class="input-text" id="contents" placeholder="" style="height:75px;"><?php echo $result["contents"];?></textarea>
			</div>
		</div>

		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 修改一个课类信息 </button>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/classs/edits_subs/<?php echo $result["id"];?>", 
				type: 'POST', 
