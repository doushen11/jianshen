<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:del_all();" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 删除所选操课</a> </span> <span class="r">共有数据：<strong><?php echo $pageall;?></strong> 条</span> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
			  ...
			  <th width="37">课程ID</th>
				<th width="138">课程状态</th>
				<th width="97">教练手机号</th>
				<th width="63">真实姓名</th>
				
				<th width="50">费用</th>
				<th width="76">课厅</th>
				<th width="76">对应日期</th>
				<th width="103">开始---结束</th>
				<th width="49">参与人数</th>
				<th width="47">开课人数</th>
				<th width="47">容纳人数</th>
				<th width="55">操作</th>
		...
		<tbody>
			...
			<tr id="zo_<?php echo $array["id"];?>" class="text-c" >
			  ...
			  <td><?php echo $array["id"];?></td>
				<td>
                <a href="<?php echo http_url();?>admin/members/caokes?keywords=<?php echo $array["id"];?>" id="state_<?php echo $array["id"];?>">
				<?php
                	if($array["state"]==1)
					{
				?>
                <strong style="color:#cc0000;">已安排,等待成立</strong>
                <?php
					}
					elseif($array["state"]==2)
					{
				?>
                <strong style="color:green;">已成立,等待满额</strong>
                <?php
					}
					elseif($array["state"]==3)
					{
				?>
                <strong style="color:#1859a5;">已经满额,等待开课</strong>
                <?php
					}
					elseif($array["state"]==4)
					{
				?>
                <strong style="color:#777;">人数不够,被取消</strong>
                <?php
					}
					elseif($array["state"]==5)
					{
				?>
                <strong style="color:#000;">课程顺利完成</strong>
                <?php
					}
				?>
                </a>
				...
				<td><strong><?php echo $array["sale"];?></strong></td>
				<td><?php echo $array["room_name"];?></td>
				...
				<td><?php echo $array["loads"];?></td>
				<td class="f-14 td-manage"><?php echo $array["min"];?></td>
				<td class="f-14 td-manage"><?php echo $array["max"];?></td>
