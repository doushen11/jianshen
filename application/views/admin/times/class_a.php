...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 私课时间安排列表 <a id="shuaxins" class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i id="wysx" class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script>
	...
	function save_submit()
	{
		...
		if(subs==1)
		{
			if(form_loads==1)
			{
				$.ajax({url:"<?php echo http_url();?>admin/times/class_a_subs",
				type: 'POST', 
