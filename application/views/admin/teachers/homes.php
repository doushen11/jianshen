...
<script>
	...
	{
		location='<?php echo http_url();?>admin/teachers/homes_edits/' + id + "?keywords=" + keywords + "&pageindex=" + pageindex + "&start_time=" + start_time + "&end_time=" + end_time + "&states=" + states + "&doors=" + doors;	
	}
	
	//会员添加
	function member_add()
	{
		location='<?php echo http_url();?>admin/teachers/homes_add/' + "" + "?keywords=" + keywords + "&pageindex=" + pageindex + "&start_time=" + start_time + "&end_time=" + end_time + "&states=" + states + "&doors=" + doors;	
	}	
	
	//会员打款
	function members_draw(id)
	{
		location='<?php echo http_url();?>admin/teachers/homes_draws/' + id + "?keywords=" + keywords + "&pageindex=" + pageindex + "&start_time=" + start_time + "&end_time=" + end_time + "&states=" + states + "&doors=" + doors;		
	}	
	
	//会员添加
	function members_add(id)
	{
		location='<?php echo http_url();?>admin/classs/caokes_add/' + id + "?keywords=" + keywords + "&pageindex=" + pageindex + "&start_time=" + start_time + "&end_time=" + end_time + "&states=" + states + "&doors=" + doors;	
	}
	...
	{
		//alert(1);
		$.ajax({url:"<?php echo http_url();?>admin/teachers/homes_ajaxs/" + pageindex + "?keywords=" + keywords + "&start_time=" + start_time + "&end_time=" + end_time + "&states=" + states + "&doors=" + doors, 
			type: 'POST', 
			dataType: 'html', 
			timeout: 15000, 
			error: function(){
	...
	function del_rs(id){
		if(form_status==0 || form_status==3){
			$.ajax({url:"<?php echo http_url();?>admin/teachers/home_dels", 
			type: 'POST', 
			data:{id:id},
			dataType: 'html', 
			timeout: 15000, 
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 教练管理 <span class="c-gray en">&gt;</span> 操课教练列表 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">说明：您如果要查看达到15次可提现会员，则在搜索文本里面填写“打款”即可获取</font><a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
