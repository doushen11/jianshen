	...
	<div class="form form-horizontal" id="form-article-add" action="#">
       ...
       <?php }?>
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" value="" id="moneys" name="moneys">
			</div>
		</div>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/teachers/indexs_draw_sub/<?php echo $result["id"];?>", 
				type: 'POST', 
