...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 教练管理 <span class="c-gray en">&gt;</span> 添加操课教练 <a id="shuaxins" class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i id="wysx" class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" id="posibel">
				<span id="rs_1">
                    ...
                    ?>
                    </select>&nbsp;&nbsp;&nbsp;<input type="text" placeholder="高峰期价格" value="" class="w2">&nbsp;&nbsp;&nbsp;<input type="text" placeholder="高峰收入点数" value="" class="w3">&nbsp;&nbsp;&nbsp;<input type="text" placeholder="低峰期价格" value="" class="w4">&nbsp;&nbsp;&nbsp;<input type="text" placeholder="低峰收入点数" value="" class="w5">&nbsp;&nbsp;&nbsp;<a href="javascript:add_one();">添加一行</a>
                    </div>
                    <div class="hehe">
                    <?php
					...
					?>
                    <?php echo $arrayz["name"];?>：&nbsp; <input type="hidden" class="w<?php echo $i;$i++;?>" value="<?php echo $arrayz["id"];?>"> <input type="text" placeholder="最少开课人数" value="" class="w<?php echo $i;$i++;?>"> &nbsp;&nbsp;&nbsp; <input type="text" placeholder="最多上课人数" value="" class="w<?php echo $i;$i++?>">&nbsp;&nbsp;&nbsp; 
                    <?php
						}
					?>
                    </div>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/teachers/home_inserts", 
				type: 'POST', 
