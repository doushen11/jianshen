	...
	<div class="form form-horizontal" id="form-article-add" action="#">
		...
		?>
         <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $arr["money_peak"];?>" placeholder="" id="money_peak" name="money_peak" style="width:7%;"> &nbsp;&nbsp;&nbsp; <font color="#FF0000">请填写高峰期服务费用</font> &nbsp;&nbsp;&nbsp; <input type="text" class="input-text" value="<?php echo $arr["money_peak_sys"];?>" placeholder="" id="money_peak_sys" name="money_peak_sys" style="width:7%;"> &nbsp;&nbsp;&nbsp; <font color="#FF0000">请填写高峰期服务费用费收益率点数，允许0.1-1之间，精确到小数点后两位</font>
			</div>
		</div>       
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>低峰期信息：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $arr["money_slack"];?>" placeholder="" id="money_slack" name="money_slack" style="width:7%;"> &nbsp;&nbsp;&nbsp; <font color="#FF0000">请填写低峰期服务费用</font> &nbsp;&nbsp;&nbsp; <input type="text" class="input-text" value="<?php echo $arr["money_slack_sys"];?>" placeholder="" id="money_slack_sys" name="money_slack_sys" style="width:7%;"> &nbsp;&nbsp;&nbsp; <font color="#FF0000">请填写低峰期服务费用费收益率点数，允许0.1-1之间，精确到小数点后两位</font>
			</div>
		</div>        
		<div class="row cl">
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/teachers/index_updates/<?php echo $result["id"];?>", 
				type: 'POST', 
