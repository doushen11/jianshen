...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 会员管理 <span class="c-gray en">&gt;</span> 给指定会员提现处理 <a id="shuaxins" class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i id="wysx" class="Hui-iconfont">&#xe68f;</i></a></nav>
<article class="page-container">
	<div class="form form-horizontal" id="form-article-add" action="#">
       ...
       <?php
       	$qy=$this->db->query("select `money`,`time` from `dg_user_draw` where `uid`='".$result["id"]."' order by `id` desc limit 1");
		if($qy->num_rows()>0){
			$rs=$qy->row_array();
	   ?>
       <div class="row cl">
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			{
				$.ajax({url:"<?php echo http_url();?>admin/members/oneline_draw_sub/<?php echo $result["id"];?>", 
				type: 'POST', 
