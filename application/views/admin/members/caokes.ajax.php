<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:del_all();" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 删除所选交易记录</a> </span> <span class="r">共有数据：<strong><?php echo $pageall;?></strong> 条</span> <span class="r">合计金额：<strong style="color:#F00;"><?php echo sprintf("%.2f",$result1["price"]);?></strong> 元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> </div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
			  <th width="22"><input type="checkbox" name="sx" id="sx" value="100" onClick="choose_all();" ></th>
			  <th width="36">ID</th>
				<th width="71">当前状态</th>
				<th width="56">课程</th>
				<th width="54">大厅</th>
				<th width="74">会员手机号</th>
				<th width="67">会员昵称</th>
				
				<th width="125">上课时间</th>
				<th width="82">购买时间</th>
				<th width="58">购买价格</th>
				<th width="36">教练</th>
				<th width="84">教练手机号</th>
            </tr>
		</thead>
		<tbody>
        	<?php
				...
				{
			?>
			<tr id="zo_<?php echo $array["id"];?>" class="text-c" style="font-size:12px;">
			  ...
			  <td><?php echo $array["id"];?></td>
				...
				<?php
					...
					{
				?>
                <strong style="color:#999999;">未成立系统取消订单</strong>
                <?php
					}
				...
				<td><?php echo $array["class_name"];?></td>
				...
				<td><strong style="color:#1859a5;"><p><?php echo $array["date"];?></p><p><?php echo $array["node"];?></p></strong></td>
				<td>
				<?php
                	if($array["time"]>=$s_time && $array["time"]<=$e_time)
					{
				?>
                <strong style="color:#F00;"><p><?php echo date("Y-m-d",$array["time"]);?></p><p><?php echo date("H:i:s",$array["time"]);?></p></strong>
                <?php
					}
					else
					{
				?>
                <p><?php echo date("Y-m-d",$array["time"]);?></p><p><?php echo date("H:i:s",$array["time"]);?></p>
                <?php
					}
				?>                
                </td>
